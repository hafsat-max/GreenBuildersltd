...
function ProjectHero({tag, name, description, location, linkBase, project, vidLink}: {tag: string, name: string, description: string, location: string, linkBase?: string, project?: boolean, vidLink?: string}) {
